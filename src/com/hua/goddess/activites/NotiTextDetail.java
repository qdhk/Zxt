...
import com.hua.goddess.fragment.NotiTextDetailFragement;
 ...
 * 
 */
public class NotiTextDetail extends SwipeBackActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getSupportFragmentManager().beginTransaction()
				.replace(R.id.container, new NotiTextDetailFragement(URL, sm))
				.commit();
		getSupportFragmentManager()
				.beginTransaction()
				.replace(R.id.comments_list_container,
						new CommentsFragment(URL)).commit();
	}
	...
	private void initSlidingMenu() {
		...
		sm = new SlidingMenu(NotiTextDetail.this);
