...
import com.hua.goddess.fragment.About_hdgbtFragement;
import com.umeng.analytics.MobclickAgent;

public class About_HdgbtActivity extends SwipeBackActivity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_shots_detail);
		setActionBarStyle("社团详情");
		getSupportFragmentManager().beginTransaction()
				.replace(R.id.container, new About_hdgbtFragement()).commit();
	}
